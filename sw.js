const CACHE='mastarklass-os-11.15.37';
const ASSETS=['./','./index.html','./app.js?v=11.15.37','./styles.css?v=11.15.37','./manifest.json?v=11.15.37','./icon.svg','./version.json?v=11.15.37'];
