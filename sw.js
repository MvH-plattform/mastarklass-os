const CACHE='mastarklass-os-11.15.42';
const ASSETS=['./','./index.html','./app.js?v=11.15.42','./styles.css?v=11.15.42','./manifest.json?v=11.15.42','./icon.svg','./version.json?v=11.15.42'];
