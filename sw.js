const CACHE='mastarklass-os-11.15.38';
const ASSETS=['./','./index.html','./app.js?v=11.15.38','./styles.css?v=11.15.38','./manifest.json?v=11.15.38','./icon.svg','./version.json?v=11.15.38'];
