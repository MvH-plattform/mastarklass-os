const CACHE='mastarklass-os-11.15.46';
const ASSETS=['./','./index.html','./app.js?v=11.15.46','./styles.css?v=11.15.46','./manifest.json?v=11.15.46','./icon.svg','./version.json?v=11.15.46'];
