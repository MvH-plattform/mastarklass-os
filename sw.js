const CACHE='mastarklass-os-11.15.45';
const ASSETS=['./','./index.html','./app.js?v=11.15.45','./styles.css?v=11.15.45','./manifest.json?v=11.15.45','./icon.svg','./version.json?v=11.15.45'];
