const CACHE='mastarklass-os-11.15.48';
const ASSETS=['./','./index.html','./app.js?v=11.15.48','./styles.css?v=11.15.48','./manifest.json?v=11.15.48','./icon.svg','./version.json?v=11.15.48'];
