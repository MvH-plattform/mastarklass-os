const CACHE='mastarklass-os-11.15.44';
const ASSETS=['./','./index.html','./app.js?v=11.15.44','./styles.css?v=11.15.44','./manifest.json?v=11.15.44','./icon.svg','./version.json?v=11.15.44'];
