const CACHE='mastarklass-os-11.15.49';
const ASSETS=['./','./index.html','./app.js?v=11.15.49','./styles.css?v=11.15.49','./manifest.json?v=11.15.49','./icon.svg','./version.json?v=11.15.49'];
