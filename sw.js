const CACHE='mastarklass-os-10.2.0';
const CORE=['./','./index.html','./styles.css?v=10.2.0','./app.js?v=10.2.0','./manifest.json?v=10.2.0','./icon.svg?v=10.2.0','./version.json?v=10.2.0'];
