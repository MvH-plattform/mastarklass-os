const CACHE='mastarklass-os-10.1.1';
const CORE=['./','./index.html','./styles.css?v=10.1.1','./app.js?v=10.1.1','./manifest.json?v=10.1.1','./icon.svg?v=10.1.1','./version.json?v=10.1.1'];
