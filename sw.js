const CACHE='mastarklass-os-11.15.43';
const ASSETS=['./','./index.html','./app.js?v=11.15.43','./styles.css?v=11.15.43','./manifest.json?v=11.15.43','./icon.svg','./version.json?v=11.15.43'];
