const CACHE='mastarklass-os-11.15.39';
const ASSETS=['./','./index.html','./app.js?v=11.15.39','./styles.css?v=11.15.39','./manifest.json?v=11.15.39','./icon.svg','./version.json?v=11.15.39'];
