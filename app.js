...
async function boot(){
 ...
 bridgePortfolioToIdentity();refreshUnifiedIdentity();setTimeout(()=>{canonicalCache=null;bridgePortfolioToIdentity();refreshUnifiedIdentity({renderAfter:true})},350);
